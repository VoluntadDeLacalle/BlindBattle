...
public class InputKeyUI : MonoBehaviour
{
    ...
    public void Refresh()
    {
        ...
        {
            //if (inputActionMap != null && GameSessionManager.Instance.lastDetectedDevice != null)
            //{
            //    var scheme = InputControlScheme.FindControlSchemeForDevice(GameSessionManager.Instance.lastDetectedDevice,
            //        inputActionMap.controlSchemes);
            //    if (scheme.HasValue)
            //    {
            //        OnControlSchemeChanged(scheme.Value.name);
